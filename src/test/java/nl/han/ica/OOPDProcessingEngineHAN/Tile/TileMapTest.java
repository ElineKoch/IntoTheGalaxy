...
import nl.han.ica.OOPDProcessingEngineHAN.PGraphicsStub.PGraphicsCreatorMock;
import nl.han.ica.OOPDProcessingEngineHAN.PGraphicsStub.PGraphicsMock;
...
public class TileMapTest {
    ...
    public void getTileOnPosition() {
        tileMap.setTileSize(10);
        assertEquals(tileMap.getTileOnPosition(40, 10).getClass(), testTileTypes[0].getClassType());
    }
