...
public class SpriteTest {
    ...
    {
        sprite = new Sprite("src/test/java/nl/han/ica/oopdprocessingenginehan/objects/box.png");
    ...
    {
        sprite = new Sprite("src/test/java/nl/han/ica/oopdprocessingenginehan/objects/WaterTile.gif");
        assertNotNull(sprite.getPImage());
    }
    ...
    {
        sprite.setSprite("src/test/java/nl/han/ica/oopdprocessingenginehan/objects/box.png");
        assertNotNull(sprite.getPImage());
    }
